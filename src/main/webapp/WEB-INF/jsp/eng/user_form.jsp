...
<div class="container-fluid">
    ...
    <div class="row" id="header">
        <div class="col-xs-11">
            <h1 id="header_text">Test Manager</h1>
        </div>
            ...
            <table class="table table-responsive table-hover">
                ...
                <tr>
                    ...
                    <form action="/user/showTests/filter" method="post">
                        <th>
                            <input name="checkBoxSortByName" type="checkbox">Name
                        </th>
                        <th>
                            <input name="checkBoxSortByLevel" type="checkbox">Level
                        </th>
                        <th>
                            <input name="checkBoxSortByNumberOfQuestions" type="checkbox">Number of questions
                        </th>
                        <th><input id="submitButton" type="submit" value="Filter"></th>
                    </form>
                </tr>
                </thead>
                <tbody>
