...
INSERT INTO questions
    ...
    VALUES
	(1, 'Enter numerical series: 24 21	19	18	15	13	–	–	7', 'Заполните числовой ряд: 24 21	19	18	15	13	–	–	7',  1, 'ENG', 1),
  (1, 'Заполните числовой ряд: 24 21	19	18	15	13	–	–	7', 'Заполните числовой ряд: 24 21	19	18	15	13	–	–	7',  1, 'RUS', 1),
	...
	(6, 'How much will be 12*12 ?', 'Сколько будет 12*12 ?   ',3, 'ENG', 2),
	...
	(10, 'Five students put their sandwiches in paper bags. Then everyone took one package at random.<br> What is the probability that only 4 pupils will get their sandwiches?',    'Пять учеников положили свои бутерброды в бумажные пакеты. Затем каждый взял наугад один пакет.<br> Какова вероятность того, что только 4 ученика получат свои бутерброды?', 1, 'ENG', 3),
